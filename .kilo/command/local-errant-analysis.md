...
4. The script corrects the essay text using `gpt-4o-mini` via OpenAI direct API (4 correction passes at temps 0.1, 0.3, 0.5, 0.7 with edit-level majority voting ≥3 of 4 + summary)
